...
import { useBillingPlans, useDeleteBillingPlan } from "@/lib/hooks/use-query-hooks"
...
export default function BillingPlansPage() {
  const { data: plansData, isLoading: loading, refetch: fetchPlans } = useBillingPlans()
  ...
  const handleDeletePlan = async () => {
    ...
    try {
      await deleteMutation.mutateAsync(deleteDialog.plan.id)

...
export default async function PricingPage() {
  ...
  const popularPlanIndex =
    plans?.findIndex(
      (plan: any) => plan.interval_type === "monthly" && plan.price > 0
              ...
              <CardHeader className="text-center">
                ...
                <div className="mt-4">
                  ...
                  {plan.interval_type !== "one_time" && (
                    <span className="text-gray-600">
                      /{getPeriodDisplay(plan.interval_type)}
                    </span>
                  )}
                </div>
                ...
                <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                  <span className="text-blue-600 font-semibold">
                    {getCreditsDisplay(plan.credits)}
                  </span>
                </div>
              </CardHeader>
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="mt-2 text-gray-600">
                  Each resume analysis uses 1 credit. Credits reset monthly with
                  your subscription, and unused credits don't roll over.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-semibold text-gray-900">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="mt-2 text-gray-600">
                  We support PDF, Word (.doc, .docx), and plain text files.
                  Premium plans also support additional formats.
                </p>
              </div>
            </div>
          </div>

    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
            <div className="rounded-md shadow">
              <Link href="/auth/sign-up">
                <Button size="lg" className="w-full bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 text-lg">
                  Start Free Analysis
            ...
            <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
              <Link href="/features">
                <Button variant="outline" size="lg" className="w-full px-8 py-4 text-lg bg-white">
                  Learn More
                </Button>
              </Link>
            </div>
        ...
        <div className="mt-20 bg-blue-600 rounded-2xl p-8 text-center text-white">
          ...
          <p className="mt-4 text-xl text-blue-100">Get started with 10 free credits. No credit card required.</p>
          <div className="mt-6">
            <Link href="/auth/sign-up">

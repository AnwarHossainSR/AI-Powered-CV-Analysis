      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Upload your resume and get instant AI-powered insights, structured data extraction, and professional
            analysis to boost your career.
          </p>
          <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
            <div className="rounded-md shadow">
              <Link href="/auth/sign-up">
                <Button size="lg" className="w-full bg-black hover:bg-gray-800 text-white px-8 py-4 text-lg">
                  Start Free Analysis
            ...
            <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
              <Link href="/features">
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full px-8 py-4 text-lg bg-white border-black text-black hover:bg-black hover:text-white"
                >
                  Learn More
                </Button>
              </Link>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              ...
              <p className="mt-2 text-gray-600">
                Advanced AI extracts and structures data from your resume with high accuracy.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">Detailed Insights</h3>
              <p className="mt-2 text-gray-600">
                Get comprehensive analysis and actionable insights to improve your resume.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* CTA Section */}
        <div className="mt-20 bg-black rounded-2xl p-8 text-center text-white">
          <h2 className="text-3xl font-bold">Ready to analyze your resume?</h2>
          <p className="mt-4 text-xl text-gray-300">Get started with 10 free credits. No credit card required.</p>
          <div className="mt-6">
            <Link href="/auth/sign-up">

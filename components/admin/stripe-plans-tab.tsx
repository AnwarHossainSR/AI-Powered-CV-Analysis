...
import { Plus, Trash2, DollarSign, Calendar, FolderSyncIcon as Sync } from "lucide-react"
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage Stripe products with automatic database sync</p>
        </div>
        ...
        <Card className="border-purple-200">
          <CardHeader>
            ...
            <p className="text-sm text-gray-600">
              This will create a Stripe product and automatically add it to your database
            </p>
          </CardHeader>
          <CardContent>

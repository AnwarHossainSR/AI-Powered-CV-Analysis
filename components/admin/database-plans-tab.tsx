...
export function DatabasePlansTab() {
  ...
  const handleDeletePlan = async () => {
    ...
    try {
      const response = await fetch(`/api/admin/billing-plans/${deleteDialog.plan.id}`, {
        method: "DELETE",
      })
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-heading font-bold text-gray-900">Database Plans</h2>
          <p className="text-gray-600">Manage billing plans stored in your database</p>
        </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t">
                ...
                <div className="flex space-x-2">
                  ...
                  <Button
                    ...
                    onClick={() => setDeleteDialog({ isOpen: true, plan, isDeleting: false })}
                  >
      ...
      <ConfirmationDialog
        ...
        onClose={() => setDeleteDialog({ isOpen: false, plan: null, isDeleting: false })}
